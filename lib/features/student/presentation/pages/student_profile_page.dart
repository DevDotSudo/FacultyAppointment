...
class StudentProfilePage extends StatelessWidget {
  ...
  List<SidebarNavItem> _sidebarItems(BuildContext context) => [
        SidebarNavItem(label: 'Dashboard', icon: Icons.dashboard, onTap: () => context.goNamed('student-dashboard')),
        SidebarNavItem(label: 'Faculty', icon: Icons.school, onTap: () => context.goNamed('student-faculty')),
        SidebarNavItem(label: 'My Appointments', icon: Icons.calendar_today, onTap: () => context.goNamed('student-my-appointments')),
        SidebarNavItem(label: 'Profile', icon: Icons.person, isActive: true, onTap: () => context.goNamed('student-profile')),
      ];
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 14),
                    _profileField('Student ID', data['student_id'] as String? ?? ''),
                    const SizedBox(height: 20),
